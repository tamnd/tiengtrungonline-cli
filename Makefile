...
LDFLAGS := -s -w \
	-X github.com/tamnd/tiengtrungonline-cli/cli.Version=$(VERSION) \
	-X github.com/tamnd/tiengtrungonline-cli/cli.Commit=$(COMMIT) \
	-X github.com/tamnd/tiengtrungonline-cli/cli.Date=$(DATE)
