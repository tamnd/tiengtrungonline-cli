...
```
tiengtrungonline <command> [arguments] [flags]
```

Run `tiengtrungonline <command> --help` for the full flag list on any command. This
...
per operation you declare in `tiengtrungonline/domain.go`.
